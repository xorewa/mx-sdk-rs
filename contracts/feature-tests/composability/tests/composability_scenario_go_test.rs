...
#[test]
fn forw_blind_async_v_1_accept_egld_go() {
    world().run("scenarios/forw_blind_async_v1_accept_egld.scen.json");
}

#[test]
fn forw_blind_async_v_1_accept_esdt_go() {
...
#[test]
fn forw_blind_transf_exec_accept_egld_go() {
